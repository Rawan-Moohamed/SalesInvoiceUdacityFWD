...
import uda.inv.controller.Controller;
...
public class InvoiceFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        createInvoiceButton.setForeground(new java.awt.Color(255, 255, 255));
        createInvoiceButton.setText("Create New Invoice");

        deleteInvoiceButton.setBackground(this.getContentPane().getBackground());
        deleteInvoiceButton.setForeground(new java.awt.Color(255, 255, 255));
        ...
        createLineButton.setForeground(new java.awt.Color(255, 255, 255));
        createLineButton.setText("Create New Item");

        deleteLineButton.setBackground(this.getContentPane().getBackground());
        deleteLineButton.setForeground(new java.awt.Color(255, 255, 255));
        ...
        loadFileMenuItem.setForeground(new java.awt.Color(255, 255, 255));
        loadFileMenuItem.setText("Load File");
        jMenu1.add(loadFileMenuItem);

        saveFileMenuItem.setForeground(new java.awt.Color(255, 255, 255));
    ...
    public int getNextInvoiceNum() {
        ...
        for (Invoice invoice : getInvoices()) {
            if (invoice.getNumberOfInv() > num) 
                num = invoice.getNumberOfInv();
        }
